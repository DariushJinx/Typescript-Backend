...
import { IsDefined, Matches, Length, IsNotEmpty, IsEmail } from "class-validator";
...
export class CheckOtpDto {
  ...
  @IsDefined()
  @Expose()
  @Length(5, 5, { message: "کد احراز هویت وارد شده صحیح نمی باشد" })
  code: number;
}
...
export class RegisterDto {
  @IsDefined()
  @Expose()
  @Length(3, 11, { message: "تعداد کاراکترهای  یوزرنیم باید بین 3 تا 11  باشد" })
  username: string;
  @IsDefined()
  @Expose()
  first_name: string;
